...
client.on('message', (topic, message) => {
    try {
        ...
        insert.run(payload.ts, payload.temp, payload.humidity, payload.eco2, payload.tvoc, payload.alerts.temp_high ? 1 : 0, payload.alerts.temp_low ? 1 : 0, payload.alerts.humidity_high ? 1 : 0, payload.alerts.humidity_low ? 1 : 0, payload.alerts.eco2_warn ? 1 : 0, payload.alerts.eco2_bad ? 1 : 0, payload.alerts.tvoc_warn ? 1 : 0, payload.alerts.tvoc_bad ? 1 : 0);
